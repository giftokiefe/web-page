...
const Footer = () => {
  return (
    <div className="w-full bg-white py-24">
        <div className="md:max-w-[1480px] m-auto grid md:grid-cols-6 max-[780px]:grid-cols-2 gap-8 max-w-[600px]">
            ...
            <div className="col-span-2">
               ...
               <div className="flex gap-4 py-4">
                   ...
                   <div className="p-4 bg-[#E9F8F3] rounded-xl"><PiBasketballThin size={25} style={{color:"#4DC39E"}} /></div>
